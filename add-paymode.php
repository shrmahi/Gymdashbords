...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <title>Gym Dashboard | Add Paymode</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add Paymode</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add Paymode </b></h4>
                                    <hr />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="shifttype" id="shifttype" required>
                                                        ...
                                                        <option value="paymode" selected>Payment Mode</option>

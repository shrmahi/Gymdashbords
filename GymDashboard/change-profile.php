...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($con, "update tblmember set PostImage='$imgnewfile' where id='$catid'");
            if ($query) {
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
                        $catid = intval($_GET['cid']);
                        $query = mysqli_query($con, "select PostImage,FirstName,LastName from tblmember where id='$catid' and Is_Active=1 ");
                                        ...
                                        <form name="addpost" method="post">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="name"
                                                    value="<?php echo htmlentities($row['FirstName']); ?>" name="name"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>Current Profile
                                                                Image</b>
                                                        </h4>

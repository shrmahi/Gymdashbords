...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "Update  tblservices set ServiceName='$servicename' where id='$catid'");
        if ($query) {
            echo "<script>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Services </b></h4>
                                    <hr />
                                ...
                                <?php
                                $catid = intval($_GET['cid']);
                                $query = mysqli_query($con, "Select id,ServiceName from  tblservices where Is_Active=1 and id='$catid'");
                                $cnt = 1;
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo htmlentities($row['ServiceName']); ?>"
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a
                                                            ...
                                                            &nbsp;<a
                                                                href="edit-services.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del">
